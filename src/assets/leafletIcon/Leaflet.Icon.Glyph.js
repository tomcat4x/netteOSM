...
// 		shadowAnchor: [10, 12],
		...
		glyphAnchor: [0, -4]	// In pixels, counting from the center of the image.
	},
	...
	_setIconStyles: function (div, name) {
		...
		div.className = 'leaflet-marker-icon leaflet-glyph-icon ' + name + ' leaflet-glyph-icon-' + options.markerColor;
